...
namespace Arduino_SerialPortCom1
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
             ...
             dosya_oku = Directory.GetParent(Directory.GetParent(assemblyParentPath).ToString()).ToString() + "\\Tugrul_B.csv";
        ...
        void videoSource_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            Size newSize = new Size((int)(video.Width * 0.352), (int)(video.Height * 0.348));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var path = Directory.GetParent(Directory.GetParent(assemblyParentPath).ToString()).ToString() + "\\camrecord.avi";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            var result =new Uri("https://www.google.com/", UriKind.Absolute);// (Uri)new WebBrowserUriTypeConverter().ConvertFromString("https://www.google.com/");
            this.webView21.Source = result;
       ...
       /* struct FtpSetting
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //string portnumber = ((FtpSetting)e.Argument).Portnumber;
        ...
        private void backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            progressBar1.Update();
            label12.Text = $"Uploaded {e.ProgressPercentage}%";
        ...
        /*private void button5_Click(object sender, EventArgs e)
        {
            ...
            using (OpenFileDialog ofd = new OpenFileDialog() { Multiselect = false, ValidateNames = true, Filter = "All files| *.*" })
            {
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    //_inputParameter.Portnumber = "21";
                    _inputParameter.FullName = fi.FullName;
                    _inputParameter.FileName = fi.Name;
                    var deneme = Path.GetDirectoryName(ofd.FileName);
                    //WebClient webClient = new WebClient();
                    //webClient.Credentials = new NetworkCredential(_inputParameter.Name, _inputParameter.Password);
                    //webClient.UploadFile("ftp://192.168.43.86/Image/", deneme)
                    ...
                    string url = "ftp://192.168.43.86/"+_inputParameter.FileName;
                    var ftpWebRequest = WebRequest.Create(url) as FtpWebRequest;
                    ftpWebRequest.Method = WebRequestMethods.Ftp.UploadFile;
                    ftpWebRequest.Credentials =
                        new NetworkCredential(_inputParameter.Name, _inputParameter.Password);
                    byte[] fileData = GetFileData(ofd.FileName);
                    ...
                    {
                        client.Credentials = new NetworkCredential(_inputParameter.Name, _inputParameter.Password);
                        client.UploadFile("ftp://192.168.43.86/deneme.jpg", WebRequestMethods.Ftp.UploadFile,"C:\\deneme.jpg");
                    }
                    /*
                    FtpWebRequest request = (FtpWebRequest)WebRequest.Create(new Uri( "ftp://"+ _inputParameter.Server+ "/"+ _inputParameter.FileName));
                    request.Method = WebRequestMethods.Ftp.UploadFile;
                    request.Credentials = new NetworkCredential(_inputParameter.Name, _inputParameter.Password);
                    Stream ftpstream = request.GetRequestStream();
                    FileStream fs = File.OpenRead("C:\\deneme.jpg");
                    byte[] buffer = new byte[1024];
                    double total = (double)fs.Length;
                    int bytesRead = 0;
                    double read = 0;
...
*/
        ...
        private void liveCam_Click(object sender, EventArgs e)
        {
